package com.infumia.t3sl4.facmap.facscoreboard.adapters;
...
public class FactionUUID extends FactionHook {
    ...
    public FactionHook.Relation getRelation(Object f1, Object f2) throws Exception {
        ...
        else if (pf.getRelationTo(of) == com.massivecraft.factions.perms.Relation.ENEMY) return Relation.ENEMY;
        else if (pf.getRelationTo(of) == com.massivecraft.factions.perms.Relation.ALLY) return Relation.ALLY;
        else if (pf.getRelationTo(of) == com.massivecraft.factions.perms.Relation.TRUCE) return Relation.TRUCE;
        else if (pf.getRelationTo(of) == com.massivecraft.factions.perms.Relation.NEUTRAL) return Relation.NEUTRAL;
