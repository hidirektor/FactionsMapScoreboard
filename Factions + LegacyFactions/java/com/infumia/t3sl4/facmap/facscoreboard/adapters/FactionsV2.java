...
public class FactionsV2 extends FactionHook {
    ...
    public Relation getRelation(Object f1, Object f2) throws Exception {
        ...
        Rel rel = com.massivecraft.factions.util.RelationUtil.getRelationOfThatToMe(pf, of);
        ...
        else if (com.massivecraft.factions.util.RelationUtil.getRelationOfThatToMe(pf, of) == Rel.ENEMY) return Relation.ENEMY;
